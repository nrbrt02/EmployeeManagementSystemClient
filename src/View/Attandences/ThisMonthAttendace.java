 ...
 * @author ZIPTECH LTD
 */
public class ThisMonthAttendace extends javax.swing.JDialog {

    /**
     * Creates new form ThisMonthAttendace
     */
    public ThisMonthAttendace(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        LocalDate today = LocalDate.now();
        todaylabel.setText(""+today.getMonth()+"-"+today.getYear());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThisMonthAttendace.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ThisMonthAttendace dialog = new ThisMonthAttendace(new javax.swing.JFrame(), true);
