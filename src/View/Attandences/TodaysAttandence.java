 ...
 * @author ZIPTECH LTD
 */
public class TodaysAttandence extends javax.swing.JDialog {

    /**
     * Creates new form TodaysAttandence
     */
    public TodaysAttandence(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TodaysAttandence.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TodaysAttandence dialog = new TodaysAttandence(new javax.swing.JFrame(), true);
