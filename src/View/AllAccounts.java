 ...
 * @author ZIPTECH LTD
 */
public class AllAccounts extends javax.swing.JDialog {

    /**
     * Creates new form AllAccounts
     */
    public AllAccounts(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        retriveAll();
    }
    ...
    private void initComponents() {
        ...
        allAccounts = new javax.swing.JTable();
        ...
        allAccounts.setAutoCreateRowSorter(true);
        allAccounts.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "#", "Employee", "Permissions", "Account Status", "Email", "Phone"
            }
        ) {
        ...
        jScrollPane1.setViewportView(allAccounts);
...
void retriveAll() {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AllAccounts dialog = new AllAccounts(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable allAccounts;
