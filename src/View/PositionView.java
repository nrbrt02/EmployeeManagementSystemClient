...
public class PositionView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (allPositions.getColumnModel().getColumnCount() > 0) {
            allPositions.getColumnModel().getColumn(0).setPreferredWidth(1);
            allPositions.getColumnModel().getColumn(2).setResizable(false);
            allPositions.getColumnModel().getColumn(2).setPreferredWidth(20);
        }
