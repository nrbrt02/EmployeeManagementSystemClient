 ...
 * @author ZIPTECH LTD
 */
public class allProjects extends javax.swing.JDialog {

    /**
     * Creates new form allProjects
     */
    public allProjects(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        retriveAll();
    }
    ...
    private void initComponents() {
        ...
        allProjects = new javax.swing.JTable();
        ...
        allProjects.setAutoCreateRowSorter(true);
        allProjects.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "#", "Name", "Start", "End", "Status", "Desc"
            }
        ) {
        ...
        jScrollPane1.setViewportView(allProjects);
        ...
        try {
            ...
            for (Project project : allProjects) {
                ...
                tbModel.addRow(new Object[]{
                    id, name, sDate, eDate, status, desc});
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                allProjects dialog = new allProjects(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable allProjects;
