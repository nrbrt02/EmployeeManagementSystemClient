 ...
 * @author ZIPTECH LTD
 */
public class CreateAccountView extends javax.swing.JDialog {

    /**
     * Creates new form CreateAccountView
     */
    public CreateAccountView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        employeeInfo.enable(false);
    }
...
//                        JOptionPane.showMessageDialog(this, "Employee Already has an Account");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CreateAccountView dialog = new CreateAccountView(new javax.swing.JFrame(), true);
